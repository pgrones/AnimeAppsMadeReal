...
const AniList = () => {
    ...
    return (
        <a href="https://anilist.co/user/Alzariel/" target="_blank" rel="noopener noreferrer" title="Visit my AniList profile" className="mr-3 cursor-pointer hover:scale-[1.2] active:scale-100 transition-transform">
            <svg width="2.1rem" height="2.1rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                <defs>
