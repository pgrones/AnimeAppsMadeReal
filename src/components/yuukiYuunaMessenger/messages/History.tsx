    ...
    return (
        <g>
            ...
            <text fill="#fff" cursor="pointer">
                <textPath href="#historyButton" startOffset="8" alignmentBaseline="central"  dominantBaseline="central" fontSize="20" fontFamily="'Font Awesome 5 Free'">
                    &#xf35b;
                </textPath>
            </text>
            <text fill="#fff" >
                <textPath href="#historyButton" startOffset="34" alignmentBaseline="central" dominantBaseline="central" fontSize="14">
                    履歴
                </textPath>
            </text>
        </g>
